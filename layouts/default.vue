...
<template>
  <main id="main" class="min-h-screen flex flex-col justify-center items-center z-0 overflow-x-hidden"
    ...
    <slot ref="page" class="h-full flex-1" id="xxx" style="
        display: flex;
        flex-direction: column;
        justify-content: center;
        align-items: center;
      " />
    <div id="js-grained" class="w-screen h-screen inset-0 pointer-events-none"></div>
